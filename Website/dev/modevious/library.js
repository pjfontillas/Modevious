...
var $j=jQuery.noConflict();var $c=(function(){var version=120;var versionString="v1.2.0";var config={warnings:false,at:"(AT)",dot:"(DOT)",update:false,soundManager:{url:"/modevious/swf",flashVersion:9},consoleCode:[Event.KEY_UP,Event.KEY_UP,Event.KEY_DOWN,Event.KEY_DOWN,Event.KEY_LEFT,Event.KEY_RIGHT,Event.KEY_LEFT,Event.KEY_RIGHT,66,65],modeviousLocation:'/modevious/',jQueryUIThemeURL:"/modevious/jquery-ui-1.8.5.custom.css",libraryURL:"/modevious/library.css"};var loadedScripts=[];var log=[];var updateName=[];var updateVersion=[];var updateURL=[];var updateCounter=0;var consoleCounter=0;return{config:config,loadedScripts:loadedScripts,log:log,consoleCounter:consoleCounter,updateName:updateName,updateVersion:updateVersion,updateURL:updateURL,updateCounter:updateCounter,updateFound:false,getVersion:function(){return version;},init:function(){try{$c.config=$config;}catch(e){}},getVersion:function(){return version;},getVersionString:function(){return versionString;},changePage:function(pageName,objectID){$c.fetchData(pageName,null,objectID);},createCookie:function(name,value,days){var date=new Date();var expires;if(days){date.setTime(date.getTime()+(days*24*60*60*1000));expires=["; expires=",date.toGMTString()].join('');}else{expires='';}
