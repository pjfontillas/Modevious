...
copy /a Development\css\jquery-ui%1.css tmp\jquery-ui.css
...
copy /a Development\update\index.html tmp\update\index.html

:: Send Console script
copy /a Development\send_log.php tmp\send_log.php

:: copy licenses
copy /a Development\licenses.txt tmp\licenses.txt
